...
function initApp() {
   ...
   `;
    ...
    <div class="gameCol2">
        <div class="betOdds" id="${indx}-${key}-1-1-pp">${val.bets[0]} </div>
        <div class="betOdds" id="${indx}-${key}-1-2-pp">${val.bets[1]}</div>
        <div class="betOdds" id="${indx}-${key}-1-3-pp">${val.bets[2]}</div>
    </div>
    <div class="gameCol3">
